...
public class CanadianPersonalIncomeTaxRate {
    ...
    private Double endingIncome;    // might not have a value
    ...
    public static Optional<CanadianPersonalIncomeTaxRate> parseCsv(String line){
        ...
        final String DELIMITER = ",";       // final == const in C#
        /*
        ...
        // Double endingIncome = tokens[5].isBlank() ? null : Double.valueOf(tokens[5]); //add condition -> if there is no value
